...
const CoachRegistrationForm: React.FC<CoachRegistrationFormProps> = ({
  ...
  const validateForm = (): boolean => {
    ...
    if (formData.dateOfBirth) {
      ...
      if (age < 18) {
        newErrors.dateOfBirth = 'Debes tener al menos 18 años para registrarte como entrenador';
      } else if (age > 100) {
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-gray-600">
          Completa la información para crear tu cuenta de entrenador en la Federación Mexicana de Pickleball
        </p>
      </div>
