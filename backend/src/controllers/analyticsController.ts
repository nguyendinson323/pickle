...
export class AnalyticsController {
  ...
  static async getCourtDashboard(req: Request, res: Response): Promise<void> {
    try {
  ...
  static async getCourtRevenue(req: Request, res: Response): Promise<void> {
    try {
      const { courtId } = req.params;
  ...
  static async getCourtUsage(req: Request, res: Response): Promise<void> {
    try {
      const { courtId } = req.params;
      const { startDate, endDate } = req.query;
  ...
  static async getPopularityRanking(req: Request, res: Response): Promise<void> {
    try {
  ...
  static async getOwnerAnalytics(req: Request, res: Response): Promise<void> {
    try {
  ...
  static async getCourtComparison(req: Request, res: Response): Promise<void> {
    try {
      const { courtIds } = req.query;
      const { startDate, endDate } = req.query;
  ...
  static async getFederationAnalytics(req: Request, res: Response): Promise<void> {
    try {
      ...
      // Get popularity ranking for all courts (or filtered by state)
      const ranking = await AnalyticsService.getCourtPopularityRanking(
        undefined,
        undefined,
        stateId ? parseInt(stateId as string) : undefined,
      ...
      res.json({
        ...
        data: {
          ...
          topCourts: ranking.slice(0, 10), // Top 10 courts
          allCourts: ranking
        }
      });
    } catch (error: any) {
