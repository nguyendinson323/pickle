    ...
    const tournaments = [
      {
        ...
        images: ['/uploads/tournaments/verano-2024/banner.jpg', '/uploads/tournaments/verano-2024/gallery1.jpg'],
        ...
        sponsor_logos: ['/logos/sponsors/deportes-mx.png', '/logos/sponsors/raquetas-pro.png'],
      ...
      },
      {
        ...
        images: ['/uploads/tournaments/campeonato-estatal-2024/banner.jpg'],
        ...
        sponsor_logos: ['/logos/sponsors/federacion-mx.png'],
      ...
      },
      {
        ...
        images: ['/uploads/tournaments/mensual-roma-nov/banner.jpg'],
        requires_ranking: false,
        allow_late_registration: true,
      ...
      },
      {
        ...
        sponsor_logos: ['/logos/sponsors/conade.png', '/logos/sponsors/federacion-nacional.png'],
